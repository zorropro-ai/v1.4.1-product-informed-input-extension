...
function exportJson(){A.download('K-NanoMFA_multi_material_project_v20.json',JSON.stringify({app:'K-NanoMFA',version:'2.0-en',mixture:getState(),outputs:getOutputs()},null,2),'application/json');}
