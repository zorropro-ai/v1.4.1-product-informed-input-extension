...
const APP_INFO=Object.freeze({
  name:'K-NanoMFA',version:'2.0-en',initial_release_date:'2026-07-17',current_release_date:'2026-07-22',
...
function provenanceRows(){
  ...
  return [
    ...
    {group:'Dynamic nanoform-fate kinetics',cls:'E',source:'Editable v2.0 kinetic screening prior',url:'MANUAL_ADDENDUM_v2.0.md',application:'First-order operational-state kinetics; replace with nanoform-, medium-, and process-specific evidence.'}
  ];
}
...
function fitnessFlagsData(){
  ...
  flags.push({level:'warn',text:window.KNanoDynamicFate?.getState?.().enabled?'The optional v2.0 fate calculation resolves operational first-order state transitions but remains spatially aggregated and screening-level.':'Base PECs are screening calculations; enable the optional v2.0 dynamic fate engine for operational aggregation, dissolution, settling, and remobilization.'});
